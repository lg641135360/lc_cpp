...
* 函数模板的重载 形参表或类型参数表不同
  ...
  * 处理顺序
    ...
    4. 上面都找不到，则报错
    5. ![image-20210626091312850](README.assets/image-20210626091312850.png)
...
* 类模板
  ...
  * 类模板：类定义时，加上一个/多个类型参数。使用类模板时，指定类型参数应该替换成具体类型，编译器据此生成相应的模板类
    * ![image-20210628142503608](README.assets/image-20210628142503608.png)
      * class和typename一样的意思
    * ![image-20210628113323415](README.assets/image-20210628113323415.png)
  * ![image-20210628113351585](README.assets/image-20210628113351585.png)
  * 实例：Pair类模板
